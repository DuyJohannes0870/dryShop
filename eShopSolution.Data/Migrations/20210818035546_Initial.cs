    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is home page of DryShop" },
                    { "HomeKeyword", "This is keyword of DryShop" },
                    { "HomeDescription", "This is description of DryShop" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "043ffdba-60e1-4e14-9ef0-f170be581d3e", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "9f79bc41-cb42-4567-96cf-262e4d1c8935", new DateTime(2000, 3, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "bizz432000@gmail.com", true, "Duy", "Khuong", false, null, "bizz432000@gmail.com", "admin", "AQAAAAEAACcQAAAAELyfhqJN3FCIA3/oRTDhZsto/ItfWnr/4+M/MmPLFhEilwBnTQZWwqKWFZ+8qqXKvA==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2021, 8, 18, 10, 55, 45, 893, DateTimeKind.Local).AddTicks(5033), null, 100000m, 200000m },
                    { 2, new DateTime(2021, 8, 18, 10, 55, 45, 894, DateTimeKind.Local).AddTicks(5216), null, 200000m, 300000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Đậu Hạt", "hat-dau", "Hạt đậu khô", "Hạt đậu khô" },
                    { 3, 2, "vi", "Hải Sản", "hai-san", "Hải sản khô", "Hải sản khô" },
                    { 2, 1, "en", "Pea", "pea", "Dried peas", "Dried peas" },
                    { 4, 2, "en", "Seafood", "seafood", "Dried seafood", "Dried seafood" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hạt hướng dương", "Hạt hướng dương", "vi", "Hạt hướng dương", 1, "hat-huong-duong", "Hạt hướng dương", "Hạt hướng dương" },
                    { 2, "Sunflower seed", "Sunflower seed", "en", "Sunflower seed", 1, "sunflower-seed", "Sunflower seed", "Sunflower seed" },
                    { 3, "Hạt macca cao cấp", "Hạt macca cao cấp", "vi", "Hạt macca cao cấp", 2, "hat-macca-cao-cap", "Hạt macca cao cấp", "Hạt macca cao cấp" },
                    { 4, "Premium macadamia nuts", "Premium macadamia nuts", "en", "Premium macadamia nuts", 2, "Premium-macadamia-nuts", "Premium macadamia nuts", "Premium macadamia nuts" }
                });
